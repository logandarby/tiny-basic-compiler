...
Test(AST, ast_init_creates_empty_ast) {
  AST ast = ast_init();
...
Test(AST, ast_destroy_cleans_up_memory) {
  AST ast = ast_init();
...
Test(AST, ast_destroy_handles_empty_ast) {
  AST ast = ast_init();
...
Test(AST, ast_destroy_handles_null_array) {
  AST ast = ast_init();
  free(ast.node_array);
  ast.node_array = NULL;
...
Test(AST, ast_create_root_node_creates_proper_root) {
  AST ast = ast_init();
...
Test(AST, ast_head_returns_head_when_nodes_exist) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_is_token_correctly_identifies_token_nodes) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_is_grammar_correctly_identifies_grammar_nodes) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_is_token_and_grammar_are_mutually_exclusive) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_add_child_token_adds_token_correctly) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_add_child_grammar_adds_grammar_correctly) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_add_multiple_children_maintains_order) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_add_maximum_children) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_add_mixed_children_types) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_get_child_returns_correct_child) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_get_child_count_returns_correct_count) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_get_child_count_returns_zero_for_token_nodes) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_get_token_returns_correct_token) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_get_token_handles_null_text) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_get_grammar_returns_correct_type) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_get_grammar_root_node) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_creates_proper_tree_structure) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_handles_complex_expression_tree) {
  AST ast = ast_init();
...
Test(AST, ast_handles_empty_grammar_nodes) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_access_all_grammar_types) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_node_access_all_token_types) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_handles_node_array_growth) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_maintains_integrity_after_reallocation) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_builds_realistic_expression_tree) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
...
Test(AST, ast_handles_deeply_nested_structure) {
  AST ast = ast_init();
  NodeID root = create_root_node(&ast, GRAMMAR_TYPE_PROGRAM);
